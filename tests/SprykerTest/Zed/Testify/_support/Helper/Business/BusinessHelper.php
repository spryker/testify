...
class BusinessHelper extends AbstractHelper
{
     ...
     * @var string
     */
    protected const BUSINESS_LAYER_NAME = 'Zed';
    ...
    public function mockFacadeMethod(string $methodName, $return, ?string $moduleName = null)
    {
        ...
        $className = $this->resolveClassName(static::BUSINESS_FACADE_CLASS_NAME_PATTERN, $moduleName, static::BUSINESS_LAYER_NAME);
    ...
    {
        $moduleName = $this->getModuleName($moduleName);
        $className = $this->resolveClassName(static::BUSINESS_FACTORY_CLASS_NAME_PATTERN, $moduleName, static::BUSINESS_LAYER_NAME);
    ...
    {
        $moduleName = $this->getModuleName($moduleName);
        $className = $this->resolveClassName(static::SHARED_FACTORY_CLASS_NAME_PATTERN, $moduleName, static::BUSINESS_LAYER_NAME);
    ...
    {
        $moduleFactoryClassName = $this->resolveClassName(static::BUSINESS_FACTORY_CLASS_NAME_PATTERN, $moduleName, static::BUSINESS_LAYER_NAME);
